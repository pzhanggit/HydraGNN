...
for ivar in range(3):
    ...
    if icol == 0:
        ax.set_ylabel("Test loss", rotation=90, fontsize=18)
...
filenamepng = CaseDir + "/../Losshistory_SLT_MLT_ensemble_test.png"
plt.savefig(filenamepng, bbox_inches="tight")
filenamepng = CaseDir + "/../Losshistory_SLT_MLT_ensemble_test.pdf"
plt.savefig(filenamepng, bbox_inches="tight")
plt.close()
