...
if not os.path.exists(CaseDir + "/PDFofError_SLT_MLT.pkl"):
    for icase in range(len(caseslabel)):
        ...
        load_existing_model(
            model, log_name, path=CaseDir + "/logs/" + caseslabel[icase] + "/"
        )
    ...
    ######################################################################
    with open(CaseDir + "/PDFofError_SLT_MLT.pkl", "wb") as f:
        pickle.dump(error_list, f)
        pickle.dump(xcen_list, f)
        pickle.dump(pdf_list, f)
else:
    with open(CaseDir + "/PDFofError_SLT_MLT.pkl", "rb") as f:
...
filenamepng = CaseDir + "/PDFofError_SLT_MLT.png"
