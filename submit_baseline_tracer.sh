...
#SBATCH -A LRN070
#SBATCH -J HydraGNN
#SBATCH -o test-%j-baseline.out
#SBATCH -e test-%j-baseline.out
#SBATCH -t 00:10:00
#SBATCH -p batch 
##SBATCH -q debug
#SBATCH -N 1 
...
srun -N$SLURM_JOB_NUM_NODES -n$((SLURM_JOB_NUM_NODES*8)) -c7 --gpus-per-task=1 --gpu-bind=closest python -u ./examples/qm9/qm9.py --log="qm9-baseline-omnistat" #--log="qm9-baseline-tracer"
