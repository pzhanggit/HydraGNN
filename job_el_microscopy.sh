...
srun -N$SLURM_JOB_NUM_NODES -n$((SLURM_JOB_NUM_NODES*8)) -c7 --gpus-per-task=1 --gpu-bind=closest python -u ./examples/ensemble_learning/inference_microscopy.py --models_dir_folder=examples/ensemble_learning/microscopy_total_energy
