...
srun -N$SLURM_JOB_NUM_NODES -n$((SLURM_JOB_NUM_NODES*8)) -c7 --gpus-per-task=1 --gpu-bind=closest python -u ./examples/ensemble_learning/inference_GFM.py --models_dir_folder=examples/ensemble_learning/GFM_logs --multi --ddstore --multi_model_list=ANI1x-v2,MPTrj-v2,OC2020-20M-v2,OC2022-v2,qm7x-v2
